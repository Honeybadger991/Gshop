(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".showcase__slider-1")) new swiper_core_Swiper(".showcase__slider-1", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            speed: 800,
            navigation: {
                prevEl: ".showcase__slider-1-btn-prev",
                nextEl: ".showcase__slider-1-btn-next"
            },
            on: {}
        });
        if (document.querySelector(".showcase__slider-2")) new swiper_core_Swiper(".showcase__slider-2", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            speed: 800,
            navigation: {
                prevEl: ".showcase__slider-2-btn-prev",
                nextEl: ".showcase__slider-2-btn-next"
            },
            on: {}
        });
        if (document.querySelector(".showcase__slider-3")) new swiper_core_Swiper(".showcase__slider-3", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            speed: 800,
            navigation: {
                prevEl: ".showcase__slider-3-btn-prev",
                nextEl: ".showcase__slider-3-btn-next"
            },
            on: {}
        });
        if (document.querySelector(".showcase__slider-3")) new swiper_core_Swiper(".showcase__slider-3", {
        ...
        if (document.querySelector(".featured__slider")) new swiper_core_Swiper(".featured__slider", {
            modules: [ Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
    ...
    window.addEventListener("DOMContentLoaded", (() => {
        ...
        for (let i = 0; i < mobileMenuOpenBtn.length; i++) {
            ...
            mobileMenuCloseBtn[i].addEventListener("click", menuCloseFunction);
            overlay.addEventListener("click", menuCloseFunction);
        }
    }));
    window["FLS"] = true;
    isWebp();
